...
export default function Chat() {
  ...
  // Check if there are any dashboard items (excluding listings)
  useEffect(() => {
  ...
  // Get loading steps from current message
        ...
        <div className="max-w-3xl mx-auto px-4 pb-40 pt-8">
          {messages.length === 0 ? (
            ...
            <div className="flex flex-col items-center justify-center min-h-[calc(100vh-200px)]">
              <h1 className="text-6xl font-mono mb-8 text-center relative overflow-hidden">
                ...
                <div key={m.id}>
                  ...
                  {m.role === 'assistant' && (
                    <div className="py-6 space-y-4">
                      ...
                      {/* INLINE PROPERTY LISTINGS - Display below text */}
                      {m.parts.map((part) => {
                        const hasState = 'state' in part;
                        const hasToolCallId = 'toolCallId' in part;
                          ...
                          return (
                            <div key={callId} className="mt-4">
                              <ZillowListings
                                ...
                                error={output.error}
                                onPropertySelectAction={(url) => {
                                  sendMessage({ text: `show zillow property ${url}` });
                                }}
                              />
                            </div>
                          );
          ...
          <div className="max-w-3xl mx-auto px-4">
            <form onSubmit={handleSubmit} className="relative">
              <input
                ...
                className="w-full bg-white/5 text-white rounded-2xl pl-6 pr-12 py-4 
                         border border-white/10 focus:border-white/20 focus:outline-none
                         placeholder-gray-500 text-sm backdrop-blur-xl
